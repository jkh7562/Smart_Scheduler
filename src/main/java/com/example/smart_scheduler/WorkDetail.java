...
public class WorkDetail {
    ...
    public void initData(String day, String startTime, String endTime, String content, String memo) {
        Id = primary();
        week_label.setText(day);
        start_label.setText(startTime);
        end_label.setText(endTime);
    ...
    private void saveButtonAction(ActionEvent event) {
        Id = primary();
        String week = week_label.getText();
        ...
        try {
            ...
            String serverURL = "http://hbr2024.dothome.co.kr/save_workschedule.php";
            ...
            // 요청 데이터 설정
            String postData = "Id=" + Id + "&week=" + week + "&start=" + start + "&end=" + end + "&memo=" + memo;
    ...
    private void deleteButtonAction(ActionEvent event) {
        ...
        String end = end_label.getText();
        try {
            String serverURL = "http://hbr2024.dothome.co.kr/delete_work.php";
            URL url = new URL(serverURL);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setDoOutput(true);

            String postData = "Id=" + Id + "&week=" + week + "&start=" + start + "&end=" + end;
            OutputStream os = connection.getOutputStream();
            os.write(postData.getBytes("UTF-8"));
            os.close();
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("work_delete.fxml"));
                Parent root = loader.load();
                Scene scene = new Scene(root);
