...
public class monthprtyController {
    ...
    private void initialize() {
        String Id = primary();
        try {
            String serverURL = "http://hbr2024.dothome.co.kr/prtymonthget.php";
    ...
    private void deleteButtonAction(ActionEvent event) {
        Id = primary();
        try {
            String serverURL = "http://hbr2024.dothome.co.kr/deleteprtymonth.php";
            URL url = new URL(serverURL);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setDoOutput(true);
    ...
    private void saveButtonAction(ActionEvent event) {
        ...
        System.out.println();
        try {
            String serverURL = "http://hbr2024.dothome.co.kr/saveprtymonth.php";
            URL url = new URL(serverURL);
            HttpURLConnection connection = (HttpURLConnection) url.openConnection();
            connection.setRequestMethod("POST");
            connection.setDoOutput(true);
